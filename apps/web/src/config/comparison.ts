...
export interface ComparisonRow {
  ...
  readonly platform: ComparisonCell;
...
export interface Competitor {
  ...
  /** Honest guidance: when {brand} is the better fit. */
  readonly platformBestFor: Localized;
...
export const comparisons: Readonly<Record<string, Competitor>> = {
  moodle: {
    ...
    platformBestFor: { en: "Teams that want an Arabic-first, hosted platform for professional courses and cohorts without operating infrastructure.", ar: "الفرق التي تريد منصّة عربية أولًا ومُستضافة للدورات والمجموعات الاحترافية دون إدارة بنية تحتية." },
    rows: [
  ...
  thinkific: {
    ...
    platformBestFor: { en: "Academies and organizations delivering Arabic-first courses AND live cohorts with administration.", ar: "الأكاديميات والمؤسسات التي تقدّم دورات عربية أولًا ومجموعات مباشرة مع الإدارة." },
    rows: [
