...
class GenerateCertificateAction extends BaseAction
{
    ...
    public function execute(User $user, Course $course, ?int $enrollmentId = null): Certificate
    {
        [$certificate, $created] = $this->transaction(function () use ($user, $course, $enrollmentId): array {
